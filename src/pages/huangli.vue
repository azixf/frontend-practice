<template>
  <div class="calendar">
    <div class="lang">
      <a :class="{ active: state.lang === 'chs' }" @click="setLang('chs')"
        >简体中文</a
      >
      <a :class="{ active: state.lang === 'en' }" @click="setLang('en')"
        >English</a
      >
      <a :class="{ active: state.lang === 'cht' }" @click="setLang('cht')"
        >繁体中文</a
      >
    </div>
    <div class="border-right">
      <div class="row col border-bottom">
        <div class="label">
          {{ state.yearGanZhi }}{{ I18n.getMessage("label.nian") }}
        </div>
      ...
      <div class="row col border-bottom">
        <div class="label">
          {{ state.monthGanZhi }}{{ I18n.getMessage("label.yue") }}
        </div>
      ...
      <div class="row col border-bottom">
        <div class="label">
          {{ state.dayGanZhi }}{{ I18n.getMessage("label.ri") }}
        </div>
      ...
      <div class="row col bg border-bottom">
        <div style="text-align: center">
          {{ I18n.getMessage("my.jieQi") }}{{ state.prevJq }}
        </div>
      </div>
      ...
      <div class="border-bottom">
        <div class="inputs">
          ...
          <div>
            <select v-model="model.month">
              <option :value="i" v-for="i in 12">{{ i }}</option></select
            >月
          </div>
        ...
        <div>
          <div class="text-center">
            ...
            }}{{ I18n.getMessage("label.yue") }} {{ state.day
            }}{{ I18n.getMessage("label.ri") }} {{ I18n.getMessage("my.week")
            }}{{ state.weekInChinese }} {{ state.xingZuo
    ...
    <div>
      ...
      <div class="row col bg border-bottom">
        <div style="text-align: center">
          {{ I18n.getMessage("my.jieQi") }}{{ state.nextJq }}
        </div>
      </div>
      <div class="yj-container border-bottom">
